...
import { IconContainer, Player, PlayerScreenHOC, Spacer } from "components";
        ...
        <LinearGradient
          ...
          <View style={{ marginTop: 30 }}>
            ...
            <View
              ...
              <Player
                track={{ ...album?.tracks?.items?.[0], images: album?.images }}
              />
            </View>
          </View>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Track track={{ ...item, images: album?.images }} />
            )}
            ItemSeparatorComponent={() => <Spacer vertical space={7} />}
          />
        </LinearGradient>
      </ScrollView>
    </PlayerScreenHOC>
